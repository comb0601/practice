 ...
 *
 * Compilation:
 * cl /EHsc TangentSpace.cpp d3d11.lib dxgi.lib d3dcompiler.lib user32.lib
 */
...
bool InitDirectX(HWND hwnd) {
    ...
    std::cout << "Lesson " << 76 << ": " << "TangentSpace" << "\n";
    return true;
}
...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, int) {
    ...
    RegisterClass(&wc);
    HWND hwnd = CreateWindow("D3DWin", "Lesson 76: TangentSpace",
