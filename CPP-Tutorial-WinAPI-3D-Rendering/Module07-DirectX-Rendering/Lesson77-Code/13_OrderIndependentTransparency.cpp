/*
 * Lesson 77: Blend-States
 * Topic: OrderIndependentTransparency
 *
 * DirectX 11 implementation with full Windows integration
 *
 * Compilation:
 * cl /EHsc OrderIndependentTransparency.cpp d3d11.lib dxgi.lib d3dcompiler.lib user32.lib
 */
...
bool InitDirectX(HWND hwnd) {
    ...
    std::cout << "Lesson " << 77 << ": " << "OrderIndependentTransparency" << "\n";
    return true;
}
...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, int) {
    ...
    RegisterClass(&wc);
    HWND hwnd = CreateWindow("D3DWin", "Lesson 77: OrderIndependentTransparency",
