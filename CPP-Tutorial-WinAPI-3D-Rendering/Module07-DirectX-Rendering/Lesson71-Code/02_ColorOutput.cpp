 ...
 *
 * Compilation:
 * cl /EHsc ColorOutput.cpp d3d11.lib dxgi.lib d3dcompiler.lib user32.lib
 */
...
bool InitDirectX(HWND hwnd) {
    ...
    std::cout << "Lesson " << 71 << ": " << "ColorOutput" << "\n";
    return true;
}
...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, int) {
    ...
    RegisterClass(&wc);
    HWND hwnd = CreateWindow("D3DWin", "Lesson 71: ColorOutput",
