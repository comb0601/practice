 ...
 * Topic: MeshOptimization
 *
 * DirectX 11 implementation with full Windows integration
 *
 * Compilation:
 * cl /EHsc MeshOptimization.cpp d3d11.lib dxgi.lib d3dcompiler.lib user32.lib
 */
...
bool InitDirectX(HWND hwnd) {
    ...
    std::cout << "Lesson " << 79 << ": " << "MeshOptimization" << "\n";
    return true;
}
...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, int) {
    ...
    RegisterClass(&wc);
    HWND hwnd = CreateWindow("D3DWin", "Lesson 79: MeshOptimization",
