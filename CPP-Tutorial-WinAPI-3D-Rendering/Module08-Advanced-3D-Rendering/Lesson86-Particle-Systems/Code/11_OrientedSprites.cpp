 ...
 * Advanced Topic: OrientedSprites
 *
 * Advanced 3D rendering techniques with DirectX 11
 *
 * Compilation:
 * cl /EHsc OrientedSprites.cpp d3d11.lib dxgi.lib d3dcompiler.lib user32.lib
 */
...
public:
    ...
    bool SetupResources() {
        std::cout << "Setting up resources for: OrientedSprites\n";
        // Topic-specific initialization
        return true;
    }

    void Render() {
        // Advanced rendering logic for OrientedSprites
        std::cout << "Rendering: OrientedSprites\n";
    }
...
int main() {
    ...
    std::cout << "Topic: OrientedSprites\n\n";
