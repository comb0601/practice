/*
 * Lesson 84: Bloom-HDR
 * Advanced Topic: UpSample
 *
 * Advanced 3D rendering techniques with DirectX 11
 *
 * Compilation:
 * cl /EHsc UpSample.cpp d3d11.lib dxgi.lib d3dcompiler.lib user32.lib
 */
...
public:
    ...
    bool SetupResources() {
        std::cout << "Setting up resources for: UpSample\n";
        // Topic-specific initialization
        return true;
    }

    void Render() {
        // Advanced rendering logic for UpSample
        std::cout << "Rendering: UpSample\n";
    }
