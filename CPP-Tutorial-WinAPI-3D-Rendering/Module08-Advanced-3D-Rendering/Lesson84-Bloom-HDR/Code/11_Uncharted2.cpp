/*
 * Lesson 84: Bloom-HDR
 * Advanced Topic: Uncharted2
 *
 * Advanced 3D rendering techniques with DirectX 11
 *
 * Compilation:
 * cl /EHsc Uncharted2.cpp d3d11.lib dxgi.lib d3dcompiler.lib user32.lib
 */
...
public:
    ...
    bool SetupResources() {
        std::cout << "Setting up resources for: Uncharted2\n";
        // Topic-specific initialization
        return true;
    }

    void Render() {
        // Advanced rendering logic for Uncharted2
        std::cout << "Rendering: Uncharted2\n";
    }
