/*
 * Lesson 84: Bloom-HDR
 * Advanced Topic: BloomExtraction
 *
 * Advanced 3D rendering techniques with DirectX 11
 *
 * Compilation:
 * cl /EHsc BloomExtraction.cpp d3d11.lib dxgi.lib d3dcompiler.lib user32.lib
 */
...
public:
    ...
    bool SetupResources() {
        std::cout << "Setting up resources for: BloomExtraction\n";
        // Topic-specific initialization
        return true;
    }

    void Render() {
        // Advanced rendering logic for BloomExtraction
        std::cout << "Rendering: BloomExtraction\n";
    }
...
int main() {
    ...
    std::cout << "Topic: BloomExtraction\n\n";
