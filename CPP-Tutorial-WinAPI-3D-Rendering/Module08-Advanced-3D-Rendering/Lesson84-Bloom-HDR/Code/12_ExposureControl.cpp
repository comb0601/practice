/*
 * Lesson 84: Bloom-HDR
 * Advanced Topic: ExposureControl
 *
 * Advanced 3D rendering techniques with DirectX 11
 *
 * Compilation:
 * cl /EHsc ExposureControl.cpp d3d11.lib dxgi.lib d3dcompiler.lib user32.lib
 */
...
public:
    ...
    bool SetupResources() {
        std::cout << "Setting up resources for: ExposureControl\n";
        // Topic-specific initialization
        return true;
    }

    void Render() {
        // Advanced rendering logic for ExposureControl
        std::cout << "Rendering: ExposureControl\n";
    }
...
int main() {
    ...
    std::cout << "Topic: ExposureControl\n\n";
