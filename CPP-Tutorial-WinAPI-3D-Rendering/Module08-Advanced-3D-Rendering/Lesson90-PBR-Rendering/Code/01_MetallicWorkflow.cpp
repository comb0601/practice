 ...
 * Advanced Topic: MetallicWorkflow
 *
 * Advanced 3D rendering techniques with DirectX 11
 *
 * Compilation:
 * cl /EHsc MetallicWorkflow.cpp d3d11.lib dxgi.lib d3dcompiler.lib user32.lib
 */
...
public:
    ...
    bool SetupResources() {
        std::cout << "Setting up resources for: MetallicWorkflow\n";
        // Topic-specific initialization
        return true;
    }

    void Render() {
        // Advanced rendering logic for MetallicWorkflow
        std::cout << "Rendering: MetallicWorkflow\n";
    }
...
int main() {
    ...
    std::cout << "Topic: MetallicWorkflow\n\n";
