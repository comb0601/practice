 ...
 * Advanced Topic: ImageBasedLighting
 *
 * Advanced 3D rendering techniques with DirectX 11
 *
 * Compilation:
 * cl /EHsc ImageBasedLighting.cpp d3d11.lib dxgi.lib d3dcompiler.lib user32.lib
 */
...
public:
    ...
    bool SetupResources() {
        std::cout << "Setting up resources for: ImageBasedLighting\n";
        // Topic-specific initialization
        return true;
    }

    void Render() {
        // Advanced rendering logic for ImageBasedLighting
        std::cout << "Rendering: ImageBasedLighting\n";
    }
...
int main() {
    std::cout << "=== Lesson 90: PBR-Rendering ===\n";
    std::cout << "Topic: ImageBasedLighting\n\n";
