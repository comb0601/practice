/*
 * Lesson 85: SSAO
 * Advanced Topic: OcclusionFactors
 *
 * Advanced 3D rendering techniques with DirectX 11
 *
 * Compilation:
 * cl /EHsc OcclusionFactors.cpp d3d11.lib dxgi.lib d3dcompiler.lib user32.lib
 */
...
public:
    ...
    bool SetupResources() {
        std::cout << "Setting up resources for: OcclusionFactors\n";
        // Topic-specific initialization
        return true;
    }

    void Render() {
        // Advanced rendering logic for OcclusionFactors
        std::cout << "Rendering: OcclusionFactors\n";
    }
...
int main() {
    ...
    std::cout << "Topic: OcclusionFactors\n\n";
