/*
 * Lesson 85: SSAO
 * Advanced Topic: HalfResolution
 *
 * Advanced 3D rendering techniques with DirectX 11
 *
 * Compilation:
 * cl /EHsc HalfResolution.cpp d3d11.lib dxgi.lib d3dcompiler.lib user32.lib
 */
...
public:
    ...
    bool SetupResources() {
        std::cout << "Setting up resources for: HalfResolution\n";
        // Topic-specific initialization
        return true;
    }

    void Render() {
        // Advanced rendering logic for HalfResolution
        std::cout << "Rendering: HalfResolution\n";
    }
