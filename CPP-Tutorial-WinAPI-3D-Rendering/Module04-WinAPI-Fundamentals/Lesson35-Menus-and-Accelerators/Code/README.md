# Menus and Accelerators - Code Examples

This directory contains 20 complete Windows API applications demonstrating Menus and Accelerators.

## Overview

Lesson 35 covers menus and accelerators in the Windows API, providing practical examples of Windows application development.
...
This lesson covers:
- Menus and Accelerators concepts and implementation
...
- Implement menus and accelerators in your Windows programs
...
Each file is a complete, runnable Windows application that demonstrates specific aspects of menus and accelerators:
