# Keyboard and Mouse Input - Code Examples

This directory contains 20 complete Windows API applications demonstrating Keyboard and Mouse Input.

## Overview

Lesson 34 covers keyboard and mouse input in the Windows API, providing practical examples of Windows application development.
...
This lesson covers:
- Keyboard and Mouse Input concepts and implementation
...
- Implement keyboard and mouse input in your Windows programs
...
Each file is a complete, runnable Windows application that demonstrates specific aspects of keyboard and mouse input:
