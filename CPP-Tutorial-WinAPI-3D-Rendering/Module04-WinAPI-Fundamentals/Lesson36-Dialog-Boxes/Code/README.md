# Dialog Boxes - Code Examples

This directory contains 20 complete Windows API applications demonstrating Dialog Boxes.

## Overview

Lesson 36 covers dialog boxes in the Windows API, providing practical examples of Windows application development.
...
This lesson covers:
- Dialog Boxes concepts and implementation
...
- Implement dialog boxes in your Windows programs
...
Each file is a complete, runnable Windows application that demonstrates specific aspects of dialog boxes:
