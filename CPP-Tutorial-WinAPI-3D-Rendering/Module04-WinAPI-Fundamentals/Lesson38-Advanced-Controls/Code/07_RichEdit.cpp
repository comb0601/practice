/* Lesson 38, Example 07: Rich edit control
 * Complete WinAPI program demonstrating RichEdit
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"RichEditClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"RichEditClass", L"Rich edit control",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        ...
        case WM_PAINT: {
            ...
            const wchar_t* text = L"Rich edit control";
            TextOut(hdc, 10, 10, text, (int)wcslen(text));
            const wchar_t* info = L"This example demonstrates RichEdit in WinAPI";
