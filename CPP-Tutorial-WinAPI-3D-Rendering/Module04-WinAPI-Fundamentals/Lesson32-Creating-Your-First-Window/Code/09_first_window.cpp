 ...
 *
 * Compilation (MinGW): g++ -std=c++17 09_first_window.cpp -o example_9.exe -lgdi32 -luser32 -mwindows
 * Compilation (MSVC): cl 09_first_window.cpp /Fe:example_9.exe user32.lib gdi32.lib
 */
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    HWND hwnd = CreateWindowEx(
        WS_EX_CLIENTEDGE,
        g_szClassName,
        "Creating Your First Window - Example 9",
        WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    switch (msg) {
        ...
        case WM_PAINT: {
            ...
            // Draw text
            const char* text = "Creating Your First Window - Example 9";
