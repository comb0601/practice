 ...
 *
 * Compilation (MinGW): g++ -std=c++17 06_first_window.cpp -o example_6.exe -lgdi32 -luser32 -mwindows
 * Compilation (MSVC): cl 06_first_window.cpp /Fe:example_6.exe user32.lib gdi32.lib
 */
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    HWND hwnd = CreateWindowEx(
        WS_EX_CLIENTEDGE,
        g_szClassName,
        "Creating Your First Window - Example 6",
        WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    switch (msg) {
        ...
        case WM_PAINT: {
            ...
            // Draw text
            const char* text = "Creating Your First Window - Example 6";
