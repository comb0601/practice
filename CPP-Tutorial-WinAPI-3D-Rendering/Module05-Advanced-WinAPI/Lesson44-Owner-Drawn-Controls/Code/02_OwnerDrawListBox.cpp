/* Lesson 44, Example 02: Owner-drawn list box
 * Advanced WinAPI program demonstrating OwnerDrawListBox
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"OwnerDrawListBoxClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"OwnerDrawListBoxClass", L"Lesson 44: Owner-drawn list box",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: Owner-drawn list box
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 44: OwnerDrawListBox");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Owner-drawn list box";
