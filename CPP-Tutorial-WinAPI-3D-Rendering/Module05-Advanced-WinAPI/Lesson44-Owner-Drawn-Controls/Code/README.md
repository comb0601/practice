# Owner-Drawn Controls - Code Examples

This directory contains 20 complete Windows API applications demonstrating Owner-Drawn Controls.

## Overview

Lesson 44 covers owner-drawn controls in the Windows API, providing practical examples of Windows application development.
...
This lesson covers:
- Owner-Drawn Controls concepts and implementation
...
- Implement owner-drawn controls in your Windows programs
...
Each file is a complete, runnable Windows application that demonstrates specific aspects of owner-drawn controls:
