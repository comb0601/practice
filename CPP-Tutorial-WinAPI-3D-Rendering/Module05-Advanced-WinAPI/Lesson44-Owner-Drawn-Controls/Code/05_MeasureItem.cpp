/* Lesson 44, Example 05: WM_MEASUREITEM
 * Advanced WinAPI program demonstrating MeasureItem
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"MeasureItemClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"MeasureItemClass", L"Lesson 44: WM_MEASUREITEM",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 44: MeasureItem");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"WM_MEASUREITEM";
