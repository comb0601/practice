/* Lesson 44, Example 03: Custom menu drawing
 * Advanced WinAPI program demonstrating OwnerDrawMenu
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    ...
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"OwnerDrawMenuClass", L"Lesson 44: Custom menu drawing",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: Custom menu drawing
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 44: OwnerDrawMenu");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Custom menu drawing";
