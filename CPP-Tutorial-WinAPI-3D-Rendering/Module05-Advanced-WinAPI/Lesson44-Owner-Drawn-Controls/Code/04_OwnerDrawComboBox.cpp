/* Lesson 44, Example 04: Owner-drawn combo box
 * Advanced WinAPI program demonstrating OwnerDrawComboBox
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"OwnerDrawComboBoxClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"OwnerDrawComboBoxClass", L"Lesson 44: Owner-drawn combo box",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: Owner-drawn combo box
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 44: OwnerDrawComboBox");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Owner-drawn combo box";
