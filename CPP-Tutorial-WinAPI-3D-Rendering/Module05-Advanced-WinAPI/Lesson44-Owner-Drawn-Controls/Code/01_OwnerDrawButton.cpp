/* Lesson 44, Example 01: WM_DRAWITEM for buttons
 * Advanced WinAPI program demonstrating OwnerDrawButton
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"OwnerDrawButtonClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"OwnerDrawButtonClass", L"Lesson 44: WM_DRAWITEM for buttons",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: WM_DRAWITEM for buttons
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 44: OwnerDrawButton");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"WM_DRAWITEM for buttons";
