/* Lesson 49, Example 02: Setting clipboard data
 * Advanced WinAPI program demonstrating SetClipboardData
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"SetClipboardDataClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"SetClipboardDataClass", L"Lesson 49: Setting clipboard data",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: Setting clipboard data
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 49: SetClipboardData");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Setting clipboard data";
