/* Lesson 53, Example 04: Property sheet
 * Advanced WinAPI program demonstrating PropertySheet
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"PropertySheetClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"PropertySheetClass", L"Lesson 53: Property sheet",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 53: PropertySheet");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Property sheet";
