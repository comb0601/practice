/* Lesson 53, Example 08: Animation control
 * Advanced WinAPI program demonstrating Animation
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    ...
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"AnimationClass", L"Lesson 53: Animation control",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 53: Animation");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Animation control";
