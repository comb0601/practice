/* Lesson 43, Example 02: Superclassing controls
 * Advanced WinAPI program demonstrating SuperclassingControl
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"SuperclassingControlClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"SuperclassingControlClass", L"Lesson 43: Superclassing controls",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: Superclassing controls
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 43: SuperclassingControl");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Superclassing controls";
