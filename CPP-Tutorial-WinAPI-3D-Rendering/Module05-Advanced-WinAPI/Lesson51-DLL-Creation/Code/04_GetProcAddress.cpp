/* Lesson 51, Example 04: Getting function pointers
 * Advanced WinAPI program demonstrating GetProcAddress
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"GetProcAddressClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"GetProcAddressClass", L"Lesson 51: Getting function pointers",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: Getting function pointers
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 51: GetProcAddress");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Getting function pointers";
