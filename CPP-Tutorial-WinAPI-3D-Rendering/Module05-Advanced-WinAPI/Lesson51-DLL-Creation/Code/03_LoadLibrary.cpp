/* Lesson 51, Example 03: Dynamic DLL loading
 * Advanced WinAPI program demonstrating LoadLibrary
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"LoadLibraryClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"LoadLibraryClass", L"Lesson 51: Dynamic DLL loading",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: Dynamic DLL loading
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 51: LoadLibrary");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Dynamic DLL loading";
