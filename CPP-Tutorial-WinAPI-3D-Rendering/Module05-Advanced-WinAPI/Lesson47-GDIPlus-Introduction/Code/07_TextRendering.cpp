/* Lesson 47, Example 07: High-quality text
 * Advanced WinAPI program demonstrating TextRendering
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"TextRenderingClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"TextRenderingClass", L"Lesson 47: High-quality text",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 47: TextRendering");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"High-quality text";
