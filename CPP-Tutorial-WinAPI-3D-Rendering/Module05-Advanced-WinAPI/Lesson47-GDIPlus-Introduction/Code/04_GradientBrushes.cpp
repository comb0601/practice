/* Lesson 47, Example 04: Linear and radial gradients
 * Advanced WinAPI program demonstrating GradientBrushes
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"GradientBrushesClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"GradientBrushesClass", L"Lesson 47: Linear and radial gradients",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: Linear and radial gradients
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 47: GradientBrushes");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Linear and radial gradients";
