/* Lesson 47, Example 08: Complex shapes
 * Advanced WinAPI program demonstrating PathsAndShapes
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"PathsAndShapesClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"PathsAndShapesClass", L"Lesson 47: Complex shapes",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 47: PathsAndShapes");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Complex shapes";
