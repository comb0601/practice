 ...
 *
 * Compilation (MinGW): g++ -std=c++17 03_complete_app.cpp -o example_3.exe -lgdi32 -luser32 -lgdiplus -lole32 -loleaut32 -luuid -mwindows
 * Compilation (MSVC): cl 03_complete_app.cpp /Fe:example_3.exe user32.lib gdi32.lib gdiplus.lib ole32.lib oleaut32.lib
 */
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    HWND hwnd = CreateWindowEx(
        WS_EX_CLIENTEDGE,
        g_szClassName,
        L"Complete Windows Application - Example 3",
        WS_OVERLAPPEDWINDOW,
