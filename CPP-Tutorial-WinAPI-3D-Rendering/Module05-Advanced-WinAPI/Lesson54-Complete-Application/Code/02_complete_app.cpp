 ...
 *
 * Compilation (MinGW): g++ -std=c++17 02_complete_app.cpp -o example_2.exe -lgdi32 -luser32 -lgdiplus -lole32 -loleaut32 -luuid -mwindows
 * Compilation (MSVC): cl 02_complete_app.cpp /Fe:example_2.exe user32.lib gdi32.lib gdiplus.lib ole32.lib oleaut32.lib
 */
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    HWND hwnd = CreateWindowEx(
        WS_EX_CLIENTEDGE,
        g_szClassName,
        L"Complete Windows Application - Example 2",
        WS_OVERLAPPEDWINDOW,
