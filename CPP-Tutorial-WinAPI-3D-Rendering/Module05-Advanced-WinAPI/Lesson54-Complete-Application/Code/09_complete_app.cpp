 ...
 *
 * Compilation (MinGW): g++ -std=c++17 09_complete_app.cpp -o example_9.exe -lgdi32 -luser32 -lgdiplus -lole32 -loleaut32 -luuid -mwindows
 * Compilation (MSVC): cl 09_complete_app.cpp /Fe:example_9.exe user32.lib gdi32.lib gdiplus.lib ole32.lib oleaut32.lib
 */
                   ...
                   LPSTR lpCmdLine, int nCmdShow)
{
    ...
    HWND hwnd = CreateWindowEx(
        WS_EX_CLIENTEDGE,
        g_szClassName,
        L"Complete Windows Application - Example 9",
        WS_OVERLAPPEDWINDOW,
