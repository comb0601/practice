/* Lesson 50, Example 04: Critical sections
 * Advanced WinAPI program demonstrating CriticalSection
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"CriticalSectionClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"CriticalSectionClass", L"Lesson 50: Critical sections",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 50: CriticalSection");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Critical sections";
