/* Lesson 45, Example 06: Antialiased drawing
 * Advanced WinAPI program demonstrating AntiAliasing
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    ...
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"AntiAliasingClass", L"Lesson 45: Antialiased drawing",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: Antialiased drawing
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 45: AntiAliasing");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Antialiased drawing";
