/* Lesson 45, Example 01: BeginPath, EndPath, StrokePath
 * Advanced WinAPI program demonstrating Paths
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"PathsClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"PathsClass", L"Lesson 45: BeginPath, EndPath, StrokePath",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: BeginPath, EndPath, StrokePath
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 45: Paths");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"BeginPath, EndPath, StrokePath";
