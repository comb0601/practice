# Double Buffering - Code Examples

This directory contains 20 complete Windows API applications demonstrating Double Buffering.

## Overview

Lesson 46 covers double buffering in the Windows API, providing practical examples of Windows application development.
...
This lesson covers:
- Double Buffering concepts and implementation
...
- Implement double buffering in your Windows programs
...
Each file is a complete, runnable Windows application that demonstrates specific aspects of double buffering:
