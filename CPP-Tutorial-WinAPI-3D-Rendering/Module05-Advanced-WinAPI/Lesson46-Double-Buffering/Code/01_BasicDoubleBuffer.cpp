/* Lesson 46, Example 01: Basic double buffering
 * Advanced WinAPI program demonstrating BasicDoubleBuffer
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"BasicDoubleBufferClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"BasicDoubleBufferClass", L"Lesson 46: Basic double buffering",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: Basic double buffering
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 46: BasicDoubleBuffer");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Basic double buffering";
