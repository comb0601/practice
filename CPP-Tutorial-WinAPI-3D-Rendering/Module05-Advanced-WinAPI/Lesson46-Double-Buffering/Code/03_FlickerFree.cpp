/* Lesson 46, Example 03: Eliminating flicker
 * Advanced WinAPI program demonstrating FlickerFree
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"FlickerFreeClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"FlickerFreeClass", L"Lesson 46: Eliminating flicker",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: Eliminating flicker
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 46: FlickerFree");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Eliminating flicker";
