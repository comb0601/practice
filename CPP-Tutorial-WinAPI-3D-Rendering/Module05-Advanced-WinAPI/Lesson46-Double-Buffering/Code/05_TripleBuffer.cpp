/* Lesson 46, Example 05: Triple buffering
 * Advanced WinAPI program demonstrating TripleBuffer
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"TripleBufferClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"TripleBufferClass", L"Lesson 46: Triple buffering",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 46: TripleBuffer");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Triple buffering";
