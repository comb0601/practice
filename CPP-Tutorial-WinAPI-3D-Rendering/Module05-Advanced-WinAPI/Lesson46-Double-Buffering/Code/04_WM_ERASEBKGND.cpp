/* Lesson 46, Example 04: Handling background erase
 * Advanced WinAPI program demonstrating WM_ERASEBKGND
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"WM_ERASEBKGNDClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"WM_ERASEBKGNDClass", L"Lesson 46: Handling background erase",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: Handling background erase
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 46: WM_ERASEBKGND");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"Handling background erase";
