/* Lesson 52, Example 03: WH_CALLWNDPROC
 * Advanced WinAPI program demonstrating WindowsHook
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"WindowsHookClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"WindowsHookClass", L"Lesson 52: WH_CALLWNDPROC",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 52: WindowsHook");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"WH_CALLWNDPROC";
