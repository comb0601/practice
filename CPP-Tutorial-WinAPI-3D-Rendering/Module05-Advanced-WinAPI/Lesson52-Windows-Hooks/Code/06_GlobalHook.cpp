/* Lesson 52, Example 06: System-wide hooks
 * Advanced WinAPI program demonstrating GlobalHook
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"GlobalHookClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"GlobalHookClass", L"Lesson 52: System-wide hooks",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 52: GlobalHook");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"System-wide hooks";
