/* Lesson 52, Example 01: WH_KEYBOARD_LL hook
 * Advanced WinAPI program demonstrating KeyboardHook
 */
#define UNICODE
#define _UNICODE
#include <windows.h>
...
int WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, PWSTR, int nShow) {
    WNDCLASSEX wc = {sizeof(wc), CS_HREDRAW|CS_VREDRAW, WindowProc, 0, 0,
                     ...
                     0, L"KeyboardHookClass", 0};
    RegisterClassEx(&wc);
    HWND hwnd = CreateWindowEx(0, L"KeyboardHookClass", L"Lesson 52: WH_KEYBOARD_LL hook",
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
        case WM_CREATE:
            // Initialize: WH_KEYBOARD_LL hook
            return 0;
        ...
        case WM_PAINT: {
            ...
            wchar_t title[256];
            wsprintf(title, L"Lesson 52: KeyboardHook");
            TextOut(hdc, 10, 10, title, (int)wcslen(title));
            
            const wchar_t* desc = L"WH_KEYBOARD_LL hook";
