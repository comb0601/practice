 ...
 * Optimization Topic: AVX512
 *
 * Performance optimization techniques
 *
 * Compilation:
 * cl /O2 /EHsc AVX512.cpp
 * g++ -O3 -std=c++17 AVX512.cpp -o AVX512
 */
...
// Optimization demonstration for: AVX512
...
int main() {
    ...
    std::cout << "Optimization Topic: AVX512\n\n";
