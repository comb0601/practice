 ...
 * Optimization Topic: KDTrees
 *
 * Performance optimization techniques
 *
 * Compilation:
 * cl /O2 /EHsc KDTrees.cpp
 * g++ -O3 -std=c++17 KDTrees.cpp -o KDTrees
 */
...
// Optimization demonstration for: KDTrees
...
int main() {
    ...
    std::cout << "Optimization Topic: KDTrees\n\n";
