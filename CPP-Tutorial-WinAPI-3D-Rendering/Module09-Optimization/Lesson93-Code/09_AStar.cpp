 ...
 * Optimization Topic: AStar
 *
 * Performance optimization techniques
 *
 * Compilation:
 * cl /O2 /EHsc AStar.cpp
 * g++ -O3 -std=c++17 AStar.cpp -o AStar
 */
...
// Optimization demonstration for: AStar
...
int main() {
    ...
    std::cout << "Optimization Topic: AStar\n\n";
