 ...
 * Optimization Topic: Octrees
 *
 * Performance optimization techniques
 *
 * Compilation:
 * cl /O2 /EHsc Octrees.cpp
 * g++ -O3 -std=c++17 Octrees.cpp -o Octrees
 */
...
// Optimization demonstration for: Octrees
...
int main() {
    ...
    std::cout << "Optimization Topic: Octrees\n\n";
