# Lesson 26: Command Routing and Update UI

**Duration**: 6 hours
**Difficulty**: Intermediate

## Table of Contents
1. Introduction to Command Routing and Update UI
2. Core Concepts
...
This lesson covers **Command Routing and Update UI** in MFC applications. Understanding these concepts is crucial for building professional Windows applications with proper user interface behavior.
...
In **Lesson 27**, we'll explore the next topic in the Document/View architecture series.

**Congratulations on completing Lesson 26!**
