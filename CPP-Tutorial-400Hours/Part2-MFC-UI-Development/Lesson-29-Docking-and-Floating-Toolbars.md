# Lesson 29: Docking and Floating Toolbars

**Duration**: 6 hours
**Difficulty**: Intermediate

## Table of Contents
1. Introduction to Docking and Floating Toolbars
2. Core Concepts
...
This lesson covers **Docking and Floating Toolbars** in MFC applications. Understanding these concepts is crucial for building professional Windows applications with proper user interface behavior.
...
In **Lesson 30**, we'll explore the next topic in the Document/View architecture series.

**Congratulations on completing Lesson 29!**
