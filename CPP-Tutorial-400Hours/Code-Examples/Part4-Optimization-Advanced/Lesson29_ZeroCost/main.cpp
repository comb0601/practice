 ...
 * Demonstrates abstraction performance
 */
...
void demonstrate_zerocost() {
    print_header("Zero-Cost Abstractions");

    std::cout << "This lesson demonstrates abstraction performance.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 29: Zero-Cost Abstractions\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_zerocost();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated abstraction performance.\n";
