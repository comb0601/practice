...
void demonstrate_prototype() {
    print_header("Prototype Pattern");

    std::cout << "This lesson demonstrates cloning objects.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 66: Prototype Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_prototype();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated cloning objects.\n";
