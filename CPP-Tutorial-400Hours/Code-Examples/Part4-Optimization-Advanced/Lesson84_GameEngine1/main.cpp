...
void demonstrate_gameengine1() {
    print_header("Game Engine Part 1");

    std::cout << "This lesson demonstrates entity component system.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 84: Game Engine Part 1\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_gameengine1();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated entity component system.\n";
