...
void demonstrate_facade() {
    print_header("Facade Pattern");

    std::cout << "This lesson demonstrates simplified interface.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 71: Facade Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_facade();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated simplified interface.\n";
