 ...
 * Demonstrates critical path optimization
 */
...
void demonstrate_hotpath() {
    print_header("Hot Path Optimization");

    std::cout << "This lesson demonstrates critical path optimization.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 13: Hot Path Optimization\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_hotpath();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated critical path optimization.\n";
