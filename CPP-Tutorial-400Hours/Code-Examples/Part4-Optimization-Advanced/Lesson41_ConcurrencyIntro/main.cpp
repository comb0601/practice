 ...
 * Demonstrates concurrency basics
 */
...
void demonstrate_concurrencyintro() {
    print_header("Concurrency Fundamentals");

    std::cout << "This lesson demonstrates concurrency basics.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 41: Concurrency Fundamentals\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_concurrencyintro();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated concurrency basics.\n";
