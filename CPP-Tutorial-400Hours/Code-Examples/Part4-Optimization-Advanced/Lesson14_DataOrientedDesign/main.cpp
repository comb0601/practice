...
void demonstrate_dataorienteddesign() {
    print_header("Data-Oriented Design");

    std::cout << "This lesson demonstrates DOD principles.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 14: Data-Oriented Design\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_dataorienteddesign();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated DOD principles.\n";
