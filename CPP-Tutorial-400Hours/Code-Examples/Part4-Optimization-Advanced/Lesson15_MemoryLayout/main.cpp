...
void demonstrate_memorylayout() {
    print_header("Memory Alignment");

    std::cout << "This lesson demonstrates alignment and padding.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 15: Memory Alignment\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_memorylayout();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated alignment and padding.\n";
