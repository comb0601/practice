 ...
 * Demonstrates interface adaptation
 */
...
void demonstrate_adapter() {
    print_header("Adapter Pattern");

    std::cout << "This lesson demonstrates interface adaptation.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 67: Adapter Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_adapter();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated interface adaptation.\n";
