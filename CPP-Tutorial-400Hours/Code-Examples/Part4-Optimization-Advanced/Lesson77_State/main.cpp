/*
 * Lesson 77: State Pattern
 * Demonstrates state-based behavior
 */
...
void demonstrate_state() {
    print_header("State Pattern");

    std::cout << "This lesson demonstrates state-based behavior.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 77: State Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_state();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated state-based behavior.\n";
