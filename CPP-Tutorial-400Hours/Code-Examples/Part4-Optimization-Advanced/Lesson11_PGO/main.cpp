...
void demonstrate_pgo() {
    print_header("Profile-Guided Optimization");

    std::cout << "This lesson demonstrates PGO techniques.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 11: Profile-Guided Optimization\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_pgo();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated PGO techniques.\n";
