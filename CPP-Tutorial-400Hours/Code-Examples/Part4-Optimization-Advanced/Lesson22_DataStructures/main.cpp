/*
 * Lesson 22: Choosing Data Structures
...
void demonstrate_datastructures() {
    print_header("Choosing Data Structures");

    std::cout << "This lesson demonstrates performance comparison.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 22: Choosing Data Structures\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_datastructures();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated performance comparison.\n";
