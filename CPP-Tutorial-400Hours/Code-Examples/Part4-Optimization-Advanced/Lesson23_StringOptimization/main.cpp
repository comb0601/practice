...
void demonstrate_stringoptimization() {
    print_header("String Optimization");

    std::cout << "This lesson demonstrates string performance.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 23: String Optimization\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_stringoptimization();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated string performance.\n";
