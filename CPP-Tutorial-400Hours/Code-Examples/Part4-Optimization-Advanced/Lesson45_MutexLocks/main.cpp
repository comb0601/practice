...
void demonstrate_mutexlocks() {
    print_header("Mutex and Locks");

    std::cout << "This lesson demonstrates synchronization.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 45: Mutex and Locks\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_mutexlocks();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated synchronization.\n";
