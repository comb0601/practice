/*
 * Lesson 25: Function Inlining
 * Demonstrates inline strategies
 */
...
void demonstrate_inlining() {
    print_header("Function Inlining");

    std::cout << "This lesson demonstrates inline strategies.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 25: Function Inlining\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_inlining();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated inline strategies.\n";
