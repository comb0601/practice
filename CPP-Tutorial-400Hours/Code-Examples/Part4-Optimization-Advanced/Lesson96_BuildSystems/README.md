...
## Overview
Complete C++ implementation demonstrating build configuration.

## Topics Covered
- CMake and MSBuild fundamentals
...
### Using Visual Studio
1. Open `Lesson96_BuildSystems.vcxproj`
...
## Expected Output
The program demonstrates CMake and MSBuild with:
