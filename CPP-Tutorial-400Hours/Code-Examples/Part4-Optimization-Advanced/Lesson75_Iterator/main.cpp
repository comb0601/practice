/*
 * Lesson 75: Iterator Pattern
 * Demonstrates sequential access
 */
...
void demonstrate_iterator() {
    print_header("Iterator Pattern");

    std::cout << "This lesson demonstrates sequential access.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 75: Iterator Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_iterator();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated sequential access.\n";
