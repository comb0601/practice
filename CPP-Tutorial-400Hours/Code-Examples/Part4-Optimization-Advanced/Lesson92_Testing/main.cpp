/*
 * Lesson 92: Testing Strategies
 * Demonstrates unit and integration tests
 */
...
void demonstrate_testing() {
    ...
    std::cout << "This lesson demonstrates unit and integration tests.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 92: Testing Strategies\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_testing();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated unit and integration tests.\n";
