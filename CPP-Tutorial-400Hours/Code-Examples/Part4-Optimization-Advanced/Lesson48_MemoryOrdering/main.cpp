/*
 * Lesson 48: Memory Ordering
 * Demonstrates memory models
 */
...
void demonstrate_memoryordering() {
    print_header("Memory Ordering");

    std::cout << "This lesson demonstrates memory models.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 48: Memory Ordering\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_memoryordering();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated memory models.\n";
