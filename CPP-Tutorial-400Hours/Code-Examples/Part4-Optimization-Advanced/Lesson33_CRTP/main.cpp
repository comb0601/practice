/*
 * Lesson 33: CRTP Pattern
 * Demonstrates Curiously Recurring Template Pattern
 */
...
void demonstrate_crtp() {
    print_header("CRTP Pattern");

    std::cout << "This lesson demonstrates Curiously Recurring Template Pattern.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 33: CRTP Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_crtp();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated Curiously Recurring Template Pattern.\n";
