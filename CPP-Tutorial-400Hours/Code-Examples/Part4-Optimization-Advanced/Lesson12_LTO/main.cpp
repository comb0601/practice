...
void demonstrate_lto() {
    print_header("Link-Time Optimization");

    std::cout << "This lesson demonstrates LTO benefits.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 12: Link-Time Optimization\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_lto();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated LTO benefits.\n";
