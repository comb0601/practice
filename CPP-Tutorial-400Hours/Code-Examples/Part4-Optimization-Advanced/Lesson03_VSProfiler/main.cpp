...
void demonstrate_vsprofiler() {
    print_header("Visual Studio Profiler");

    std::cout << "This lesson demonstrates profiling tools.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 03: Visual Studio Profiler\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_vsprofiler();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated profiling tools.\n";
