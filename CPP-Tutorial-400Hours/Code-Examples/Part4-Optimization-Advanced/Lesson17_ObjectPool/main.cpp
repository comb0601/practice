...
void demonstrate_objectpool() {
    print_header("Object Pool Pattern");

    std::cout << "This lesson demonstrates object pooling.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 17: Object Pool Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_objectpool();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated object pooling.\n";
