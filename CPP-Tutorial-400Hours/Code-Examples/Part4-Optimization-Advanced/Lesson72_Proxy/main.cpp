/*
 * Lesson 72: Proxy Pattern
 * Demonstrates controlled access
 */
...
void demonstrate_proxy() {
    print_header("Proxy Pattern");

    std::cout << "This lesson demonstrates controlled access.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 72: Proxy Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_proxy();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated controlled access.\n";
