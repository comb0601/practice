...
void demonstrate_raceconditions() {
    print_header("Race Conditions");

    std::cout << "This lesson demonstrates data races.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 44: Race Conditions\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_raceconditions();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated data races.\n";
