...
void demonstrate_cicd() {
    print_header("CI/CD Pipelines");

    std::cout << "This lesson demonstrates automation.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 93: CI/CD Pipelines\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_cicd();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated automation.\n";
