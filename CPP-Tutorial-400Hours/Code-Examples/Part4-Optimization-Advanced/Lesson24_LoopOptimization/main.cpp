 ...
 * Demonstrates loop unrolling, fusion
 */
...
void demonstrate_loopoptimization() {
    print_header("Loop Optimization");

    std::cout << "This lesson demonstrates loop unrolling, fusion.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 24: Loop Optimization\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_loopoptimization();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated loop unrolling, fusion.\n";
