/*
 * Lesson 21: Algorithm Complexity Analysis
 * Demonstrates Big-O notation
 */
...
void demonstrate_bigoanalysis() {
    print_header("Algorithm Complexity Analysis");

    std::cout << "This lesson demonstrates Big-O notation.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 21: Algorithm Complexity Analysis\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_bigoanalysis();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated Big-O notation.\n";
