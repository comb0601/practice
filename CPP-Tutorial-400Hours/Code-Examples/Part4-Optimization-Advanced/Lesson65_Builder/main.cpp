 ...
 * Demonstrates complex construction
 */
...
void demonstrate_builder() {
    print_header("Builder Pattern");

    std::cout << "This lesson demonstrates complex construction.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 65: Builder Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_builder();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated complex construction.\n";
