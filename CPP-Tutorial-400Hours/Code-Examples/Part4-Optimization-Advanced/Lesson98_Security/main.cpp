...
void demonstrate_security() {
    print_header("Security Best Practices");

    std::cout << "This lesson demonstrates secure coding.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 98: Security Best Practices\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_security();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated secure coding.\n";
