/*
 * Lesson 70: Decorator Pattern
 * Demonstrates adding functionality
 */
...
void demonstrate_decorator() {
    print_header("Decorator Pattern");

    std::cout << "This lesson demonstrates adding functionality.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 70: Decorator Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_decorator();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated adding functionality.\n";
