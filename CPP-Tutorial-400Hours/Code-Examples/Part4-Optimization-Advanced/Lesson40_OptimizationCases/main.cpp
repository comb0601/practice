...
void demonstrate_optimizationcases() {
    print_header("Real-World Optimization Cases");

    std::cout << "This lesson demonstrates case studies.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 40: Real-World Optimization Cases\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_optimizationcases();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated case studies.\n";
