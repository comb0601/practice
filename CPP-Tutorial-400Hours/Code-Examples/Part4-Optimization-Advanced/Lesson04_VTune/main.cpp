/*
 * Lesson 04: Intel VTune
 * Demonstrates advanced profiling
 */
...
void demonstrate_vtune() {
    print_header("Intel VTune");

    std::cout << "This lesson demonstrates advanced profiling.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 04: Intel VTune\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_vtune();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated advanced profiling.\n";
