 ...
 * Demonstrates return value optimization
 */
...
void demonstrate_copyelision() {
    print_header("Copy Elision and RVO");

    std::cout << "This lesson demonstrates return value optimization.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 19: Copy Elision and RVO\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_copyelision();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated return value optimization.\n";
