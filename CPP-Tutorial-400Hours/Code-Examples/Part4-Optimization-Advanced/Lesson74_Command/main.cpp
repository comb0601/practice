/*
 * Lesson 74: Command Pattern
 * Demonstrates encapsulating requests
 */
...
void demonstrate_command() {
    ...
    std::cout << "This lesson demonstrates encapsulating requests.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 74: Command Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_command();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated encapsulating requests.\n";
