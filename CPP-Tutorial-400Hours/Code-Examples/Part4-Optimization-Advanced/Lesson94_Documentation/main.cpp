...
void demonstrate_documentation() {
    print_header("API Documentation");

    std::cout << "This lesson demonstrates documentation generation.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 94: API Documentation\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_documentation();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated documentation generation.\n";
