...
void demonstrate_compileroptimization() {
    print_header("Compiler Optimization Flags");

    std::cout << "This lesson demonstrates compiler options.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 10: Compiler Optimization Flags\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_compileroptimization();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated compiler options.\n";
