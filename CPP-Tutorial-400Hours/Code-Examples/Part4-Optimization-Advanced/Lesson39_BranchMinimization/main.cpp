 ...
 * Demonstrates branchless programming
 */
...
void demonstrate_branchminimization() {
    print_header("Minimizing Branching");

    std::cout << "This lesson demonstrates branchless programming.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 39: Minimizing Branching\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_branchminimization();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated branchless programming.\n";
