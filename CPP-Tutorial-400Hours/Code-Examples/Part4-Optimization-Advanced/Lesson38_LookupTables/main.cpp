...
void demonstrate_lookuptables() {
    print_header("Lookup Tables");

    std::cout << "This lesson demonstrates precomputation.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 38: Lookup Tables\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_lookuptables();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated precomputation.\n";
