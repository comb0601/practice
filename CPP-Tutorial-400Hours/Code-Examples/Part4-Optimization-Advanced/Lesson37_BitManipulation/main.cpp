...
void demonstrate_bitmanipulation() {
    print_header("Bit Manipulation Tricks");

    std::cout << "This lesson demonstrates bit operations.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 37: Bit Manipulation Tricks\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_bitmanipulation();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated bit operations.\n";
