...
## Overview
Complete C++ implementation demonstrating automated performance tests.

## Topics Covered
- Performance Testing Framework fundamentals
...
### Using Visual Studio
1. Open `Lesson20_PerfTestingFramework.vcxproj`
...
## Expected Output
The program demonstrates Performance Testing Framework with:
