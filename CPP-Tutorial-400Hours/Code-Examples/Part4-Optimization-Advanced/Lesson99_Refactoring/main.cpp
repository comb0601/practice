/*
 * Lesson 99: Refactoring Examples
 * Demonstrates code improvement
 */
...
void demonstrate_refactoring() {
    print_header("Refactoring Examples");

    std::cout << "This lesson demonstrates code improvement.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 99: Refactoring Examples\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_refactoring();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated code improvement.\n";
