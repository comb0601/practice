/*
 * Lesson 07: Cache Optimization
 * Demonstrates cache-friendly code
 */
...
void demonstrate_cacheoptimization() {
    print_header("Cache Optimization");

    std::cout << "This lesson demonstrates cache-friendly code.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 07: Cache Optimization\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_cacheoptimization();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated cache-friendly code.\n";
