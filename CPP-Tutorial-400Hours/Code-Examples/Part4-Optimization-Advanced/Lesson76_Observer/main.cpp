/*
 * Lesson 76: Observer Pattern
 * Demonstrates event notification
 */
...
void demonstrate_observer() {
    print_header("Observer Pattern");

    std::cout << "This lesson demonstrates event notification.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 76: Observer Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_observer();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated event notification.\n";
