/*
 * Lesson 78: Strategy Pattern
 * Demonstrates algorithm selection
 */
...
void demonstrate_strategy() {
    print_header("Strategy Pattern");

    std::cout << "This lesson demonstrates algorithm selection.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 78: Strategy Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_strategy();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated algorithm selection.\n";
