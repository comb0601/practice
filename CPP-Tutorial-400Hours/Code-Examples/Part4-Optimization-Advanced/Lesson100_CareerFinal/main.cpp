/*
 * Lesson 100: Final Capstone Project
...
void demonstrate_careerfinal() {
    print_header("Final Capstone Project");

    std::cout << "This lesson demonstrates complete application.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 100: Final Capstone Project\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_careerfinal();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated complete application.\n";
