/*
 * Lesson 28: Constexpr Programming
...
void demonstrate_constexpr() {
    print_header("Constexpr Programming");

    std::cout << "This lesson demonstrates constexpr functions.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 28: Constexpr Programming\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_constexpr();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated constexpr functions.\n";
