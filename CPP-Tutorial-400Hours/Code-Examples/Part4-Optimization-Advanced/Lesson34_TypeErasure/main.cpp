 ...
 * Demonstrates polymorphism without virtual
 */
...
void demonstrate_typeerasure() {
    print_header("Type Erasure");

    std::cout << "This lesson demonstrates polymorphism without virtual.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 34: Type Erasure\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_typeerasure();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated polymorphism without virtual.\n";
