/*
 * Lesson 08: Branch Prediction
 * Demonstrates branch optimization
 */
...
void demonstrate_branchprediction() {
    print_header("Branch Prediction");

    std::cout << "This lesson demonstrates branch optimization.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 08: Branch Prediction\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_branchprediction();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated branch optimization.\n";
