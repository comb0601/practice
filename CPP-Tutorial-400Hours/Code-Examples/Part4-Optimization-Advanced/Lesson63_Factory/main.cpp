...
void demonstrate_factory() {
    print_header("Factory Pattern");

    std::cout << "This lesson demonstrates object creation.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 63: Factory Pattern\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_factory();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated object creation.\n";
