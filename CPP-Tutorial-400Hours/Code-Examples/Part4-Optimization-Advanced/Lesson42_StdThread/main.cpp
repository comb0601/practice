...
void demonstrate_stdthread() {
    print_header("std::thread Basics");

    std::cout << "This lesson demonstrates thread creation.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 42: std::thread Basics\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_stdthread();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated thread creation.\n";
