 ...
 * Demonstrates eliminating temporaries
 */
...
void demonstrate_expressiontemplates() {
    print_header("Expression Templates");

    std::cout << "This lesson demonstrates eliminating temporaries.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 32: Expression Templates\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_expressiontemplates();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated eliminating temporaries.\n";
