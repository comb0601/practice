/*
 * Lesson 81: Software Architecture
...
void demonstrate_architecture() {
    print_header("Software Architecture");

    std::cout << "This lesson demonstrates system design.\n";
    std::cout << "\nKey concepts:\n";
...
int main() {
    std::cout << "Lesson 81: Software Architecture\n";
    std::cout << std::string(60, '=') << "\n";

    demonstrate_architecture();

    print_header("Conclusion");
    std::cout << "Successfully demonstrated system design.\n";
