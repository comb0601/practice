...
int main() {
    std::cout << "==========================================" << std::endl;
    std::cout << "  Screen Space Ambient Occlusion" << std::endl;
    std::cout << "==========================================" << std::endl;
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Screen Space Ambient Occlusion", nullptr, nullptr);
    if (!window) {
