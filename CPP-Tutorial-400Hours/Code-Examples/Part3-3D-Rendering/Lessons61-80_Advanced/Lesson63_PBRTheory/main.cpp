...
int main() {
    std::cout << "==========================================" << std::endl;
    std::cout << "  PBR Theory and Examples" << std::endl;
    std::cout << "==========================================" << std::endl;
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "PBR Theory and Examples", nullptr, nullptr);
    if (!window) {
