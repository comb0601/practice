...
int main() {
    std::cout << "==========================================" << std::endl;
    std::cout << "  Complete 3D Engine Architecture" << std::endl;
    std::cout << "==========================================" << std::endl;
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Complete 3D Engine Architecture", nullptr, nullptr);
    if (!window) {
