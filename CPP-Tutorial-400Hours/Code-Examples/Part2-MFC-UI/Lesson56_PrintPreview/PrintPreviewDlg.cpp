...
CPrintPreviewDlg::CPrintPreviewDlg(CWnd* pParent)
    : CDialogEx(IDD_PRINTPREVIEW_DIALOG, pParent)
    , m_strOutput(_T(""))
{
...
BEGIN_MESSAGE_MAP(CPrintPreviewDlg, CDialogEx)
    ON_WM_PAINT()
    ON_WM_QUERYDRAGICON()
    ON_BN_CLICKED(IDC_BUTTON_TEST, &CPrintPreviewDlg::OnButtonTest)
END_MESSAGE_MAP()
...
BOOL CPrintPreviewDlg::OnInitDialog()
{
    ...
    m_strOutput = _T("Lesson 56: Print Preview\r\n\r\n");
...
void CPrintPreviewDlg::OnButtonTest()
{
    m_strOutput = _T("=== Print Preview Demo ===\r\n\r\n");
