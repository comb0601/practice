...
CChatAppDlg::CChatAppDlg(CWnd* pParent)
...
BEGIN_MESSAGE_MAP(CChatAppDlg, CDialogEx)
    ON_WM_PAINT()
    ON_WM_QUERYDRAGICON()
    ON_BN_CLICKED(IDC_BUTTON_TEST, &CChatAppDlg::OnButtonTest)
END_MESSAGE_MAP()
...
BOOL CChatAppDlg::OnInitDialog()
{
    ...
    m_strOutput = _T("Lesson 82: Complete Chat App\r\n\r\n");
...
void CChatAppDlg::OnButtonTest()
{
    m_strOutput = _T("=== Complete Chat App Demo ===\r\n\r\n");
