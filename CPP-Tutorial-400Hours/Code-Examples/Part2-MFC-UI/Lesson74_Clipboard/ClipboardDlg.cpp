...
CClipboardDlg::CClipboardDlg(CWnd* pParent)
...
BEGIN_MESSAGE_MAP(CClipboardDlg, CDialogEx)
    ON_WM_PAINT()
    ON_WM_QUERYDRAGICON()
    ON_BN_CLICKED(IDC_BUTTON_TEST, &CClipboardDlg::OnButtonTest)
END_MESSAGE_MAP()
...
BOOL CClipboardDlg::OnInitDialog()
{
    ...
    m_strOutput = _T("Lesson 74: Clipboard Operations\r\n\r\n");
...
void CClipboardDlg::OnButtonTest()
{
    m_strOutput = _T("=== Clipboard Operations Demo ===\r\n\r\n");
