...
BEGIN_MESSAGE_MAP(CMediaPlayerDlg, CDialogEx)
    ON_WM_PAINT()
    ON_WM_QUERYDRAGICON()
    ON_BN_CLICKED(IDC_BUTTON_TEST, &CMediaPlayerDlg::OnButtonTest)
END_MESSAGE_MAP()
...
BOOL CMediaPlayerDlg::OnInitDialog()
{
    ...
    m_strOutput = _T("Lesson 87: Media Player\r\n\r\n");
...
void CMediaPlayerDlg::OnButtonTest()
{
    m_strOutput = _T("=== Media Player Demo ===\r\n\r\n");
