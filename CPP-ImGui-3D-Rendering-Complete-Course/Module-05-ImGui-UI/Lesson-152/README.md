# Lesson 152: Material Editor UI

**Duration:** 2.5 hours

## Learning Objectives
- Master Material Editor UI in ImGui
...
This lesson covers Material Editor UI using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for Material Editor UI" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("Material Editor UI Example");

        ImGui::Text("This is a Material Editor UI demonstration");
