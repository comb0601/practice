# Lesson 153: Debug Tools and Profiler UI

**Duration:** 2.5 hours

## Learning Objectives
- Master Debug Tools and Profiler UI in ImGui
...
This lesson covers Debug Tools and Profiler UI using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for Debug Tools and Profiler UI" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("Debug Tools and Profiler UI Example");

        ImGui::Text("This is a Debug Tools and Profiler UI demonstration");
...
- Debug Tools and Profiler UI in ImGui
