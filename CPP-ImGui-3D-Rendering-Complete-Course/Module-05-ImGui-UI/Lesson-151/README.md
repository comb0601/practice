# Lesson 151: Scene Editor UI

**Duration:** 2.5 hours

## Learning Objectives
- Master Scene Editor UI in ImGui
...
This lesson covers Scene Editor UI using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for Scene Editor UI" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("Scene Editor UI Example");

        ImGui::Text("This is a Scene Editor UI demonstration");
