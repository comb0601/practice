# Lesson 138: Tree Views and Hierarchies

**Duration:** 2 hours

## Learning Objectives
- Master Tree Views and Hierarchies in ImGui
...
This lesson covers Tree Views and Hierarchies using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for Tree Views and Hierarchies" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("Tree Views and Hierarchies Example");

        ImGui::Text("This is a Tree Views and Hierarchies demonstration");
...
- Tree Views and Hierarchies in ImGui
