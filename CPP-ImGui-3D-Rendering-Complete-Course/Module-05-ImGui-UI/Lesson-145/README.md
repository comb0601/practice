# Lesson 145: Input Handling and Shortcuts

**Duration:** 2 hours

## Learning Objectives
- Master Input Handling and Shortcuts in ImGui
...
This lesson covers Input Handling and Shortcuts using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for Input Handling and Shortcuts" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("Input Handling and Shortcuts Example");

        ImGui::Text("This is a Input Handling and Shortcuts demonstration");
...
- Input Handling and Shortcuts in ImGui
