# Lesson 146: Docking and Multi-Viewport

**Duration:** 2.5 hours

## Learning Objectives
- Master Docking and Multi-Viewport in ImGui
...
This lesson covers Docking and Multi-Viewport using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for Docking and Multi-Viewport" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("Docking and Multi-Viewport Example");

        ImGui::Text("This is a Docking and Multi-Viewport demonstration");
...
- Docking and Multi-Viewport in ImGui
