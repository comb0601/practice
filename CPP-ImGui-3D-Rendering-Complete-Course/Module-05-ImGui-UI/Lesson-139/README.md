# Lesson 139: Drag and Drop

**Duration:** 2 hours

## Learning Objectives
- Master Drag and Drop in ImGui
...
This lesson covers Drag and Drop using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for Drag and Drop" << std::endl;
    }
    ...
    void render() {
        ...
        ImGui::Text("This is a Drag and Drop demonstration");
