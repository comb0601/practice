# Lesson 148: Custom Widgets Development

**Duration:** 2.5 hours

## Learning Objectives
- Master Custom Widgets Development in ImGui
...
This lesson covers Custom Widgets Development using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for Custom Widgets Development" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("Custom Widgets Development Example");

        ImGui::Text("This is a Custom Widgets Development demonstration");
...
- Custom Widgets Development in ImGui
