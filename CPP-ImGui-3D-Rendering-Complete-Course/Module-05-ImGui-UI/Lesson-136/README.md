# Lesson 136: Advanced Widgets and Controls

**Duration:** 2 hours

## Learning Objectives
- Master Advanced Widgets and Controls in ImGui
...
This lesson covers Advanced Widgets and Controls using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for Advanced Widgets and Controls" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("Advanced Widgets and Controls Example");

        ImGui::Text("This is a Advanced Widgets and Controls demonstration");
...
- Advanced Widgets and Controls in ImGui
