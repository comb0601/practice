# Lesson 143: ImGui Styling and Theming

**Duration:** 2 hours

## Learning Objectives
- Master ImGui Styling and Theming in ImGui
...
This lesson covers ImGui Styling and Theming using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for ImGui Styling and Theming" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("ImGui Styling and Theming Example");

        ImGui::Text("This is a ImGui Styling and Theming demonstration");
...
- ImGui Styling and Theming in ImGui
