# Lesson 147: ImGui with Multiple Render Targets

**Duration:** 2 hours

## Learning Objectives
- Master ImGui with Multiple Render Targets in ImGui
...
This lesson covers ImGui with Multiple Render Targets using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for ImGui with Multiple Render Targets" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("ImGui with Multiple Render Targets Example");

        ImGui::Text("This is a ImGui with Multiple Render Targets demonstration");
...
- ImGui with Multiple Render Targets in ImGui
