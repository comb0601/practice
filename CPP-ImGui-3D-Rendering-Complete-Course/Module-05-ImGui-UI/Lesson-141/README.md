# Lesson 141: Menu Bars and Context Menus

**Duration:** 2 hours

## Learning Objectives
- Master Menu Bars and Context Menus in ImGui
...
This lesson covers Menu Bars and Context Menus using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for Menu Bars and Context Menus" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("Menu Bars and Context Menus Example");

        ImGui::Text("This is a Menu Bars and Context Menus demonstration");
...
- Menu Bars and Context Menus in ImGui
