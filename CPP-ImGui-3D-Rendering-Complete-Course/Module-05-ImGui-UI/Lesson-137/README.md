# Lesson 137: Tables and Columns

**Duration:** 2 hours

## Learning Objectives
- Master Tables and Columns in ImGui
...
This lesson covers Tables and Columns using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for Tables and Columns" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("Tables and Columns Example");

        ImGui::Text("This is a Tables and Columns demonstration");
