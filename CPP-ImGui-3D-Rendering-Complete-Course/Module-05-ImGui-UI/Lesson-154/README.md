# Lesson 154: Asset Browser UI

**Duration:** 2.5 hours

## Learning Objectives
- Master Asset Browser UI in ImGui
...
This lesson covers Asset Browser UI using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for Asset Browser UI" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("Asset Browser UI Example");

        ImGui::Text("This is a Asset Browser UI demonstration");
