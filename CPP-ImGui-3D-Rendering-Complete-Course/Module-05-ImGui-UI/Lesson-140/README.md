# Lesson 140: Popup Windows and Modals

**Duration:** 2 hours

## Learning Objectives
- Master Popup Windows and Modals in ImGui
...
This lesson covers Popup Windows and Modals using Dear ImGui, the popular immediate-mode GUI library for C++. ImGui is essential for creating debug tools, editors, and in-game UIs for graphics applications.
...
public:
    ...
    void initialize(GLFWwindow* window) {
        ...
        std::cout << "ImGui initialized for Popup Windows and Modals" << std::endl;
    }
    ...
    void render() {
        ...
        // Custom window
        ImGui::Begin("Popup Windows and Modals Example");

        ImGui::Text("This is a Popup Windows and Modals demonstration");
...
- Popup Windows and Modals in ImGui
