# Lesson 105: Shader Uniforms and Attributes

**Duration:** 2 hours

## Learning Objectives
- Master Shader Uniforms and Attributes concepts and implementation
...
This lesson covers Shader Uniforms and Attributes, a crucial component of modern OpenGL and 3D rendering. Understanding these concepts is essential for creating high-performance graphics applications.
...
// Shader Uniforms and Attributes implementation
class OpenGLExample {
private:
    GLuint VAO, VBO;
...
public:
    OpenGLExample() : VAO(0), VBO(0), shaderProgram(0) {
        std::cout << "Initializing Shader Uniforms and Attributes" << std::endl;
    }
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "Shader Uniforms and Attributes", nullptr, nullptr);
    if (!window) {
...
- Shader Uniforms and Attributes fundamentals in OpenGL
...
- [ ] Understand Shader Uniforms and Attributes concepts
