# Lesson 125: Shadow Mapping

**Duration:** 3 hours

## Learning Objectives
- Master Shadow Mapping concepts and implementation
...
This lesson covers Shadow Mapping, a crucial component of modern OpenGL and 3D rendering. Understanding these concepts is essential for creating high-performance graphics applications.
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "Shadow Mapping", nullptr, nullptr);
    if (!window) {
...
- Shadow Mapping fundamentals in OpenGL
